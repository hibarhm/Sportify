...
export default function Favorites() {
  ...
  const favoriteTeams = [
    { name: 'Manchester United', league: 'Premier League', logo: require('../../assets/images/icon.png') },
    { name: 'Los Angeles Lakers', league: 'NBA Western Conference', logo: require('../../assets/images/icon.png') },
    { name: 'Mumbai Indians', league: 'IPL Cricket', logo: require('../../assets/images/icon.png') },
  ];

  const favoritePlayers = [
    { name: 'Cristiano Ronaldo', role: 'Striker | Football', photo: require('../../assets/images/icon.png') },
    { name: 'LeBron James', role: 'Small Forward | Basketball', photo: require('../../assets/images/icon.png') },
  ];
